...
public class GameEventManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            EventManager.Instance.onPlotEvent(plotEvents.events[plotIndex]);
            ++plotIndex;
        }
        ...
        if (cdDisaster < 0)
        {
            ...
            EventManager.Instance.onRegularEvent(disasterInfo);
            cdDisaster = 180;
        ...
        if (cdSocial < 0)
        {
            ...
            EventManager.Instance.onRegularEvent(socialInfo);
    ...
    bool CanChangeResource(string changes)
    {
        ...
        foreach (string pair in pairs)
        {
            ...
            if (element[0] != "" && ResourceManager.Instance.GetResourceCount(element[0]) + float.Parse(element[1]) < 0)
            {
                return false;
            }
        }
    ...
    void ChangeResource(string effect)
    {
        ...
        EventManager.Instance.onResourceChanged(dict, 1);
    }
}